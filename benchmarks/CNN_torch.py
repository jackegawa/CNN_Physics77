...
class TorchCNN(nn.Module):
    """
    A PyTorch implementation of the custom CNN defined in 'core/model.py'.
    Ensures identical architecture and initialization for benchmarking.
    """
    def __init__(self, out_channels=8, kernel_size=3, hidden_dim=128):
        ...
        self.conv = nn.Conv2d(
            ...
            stride=1,
            padding=0,
            bias=False  # Custom model Conv2D has no bias
        )
    ...
    def _init_weights_custom(self):
        """Match the N(0, 0.01) initialization of the custom framework."""
...
def get_data_loaders(batch_size=64):
    """
    Creates DataLoaders using the EXACT SAME numpy arrays as the custom framework.
    """
